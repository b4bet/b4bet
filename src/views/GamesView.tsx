  ...
  return (
    <div className="space-y-4 animate-fade-in">
      <div className="flex items-center gap-2 mb-2">
        <h2 className="font-display font-bold text-xl text-white">All Games</h2>
        <span className="chip bg-neon-500\/20 text-neon-300">{ALL_GAMES.length}</span>
      </div>
              ...
              {logo ? (
                ...
                <>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-1">
                    <Icon className="w-9 h-9 text-white drop-shadow-lg group-hover:scale-110 transition-transform" style={{ color: g.color }} strokeWidth={1.5} />
